    	...
    	table: {
    		...
    		exportExcel: function(formId) {
    			...
    			$.modal.confirm("确定导出所有" + table.options.modalName + "吗？", function() {
	    			...
	    			dataParam.push({ "name": "orderBy", "value": params.sortName });
        ...
        operate: {
            ...
            remove: function(id) {
            	...
            	$.modal.confirm("确定删除该条" + table.options.modalName + "信息吗？", function() {
                    var url = $.common.isEmpty(id) ? table.options.removeUrl : table.options.removeUrl.replace("{ids}", id);
            ...
            removeAll: function() {
        		...
        		$.modal.confirm("确认要删除选中的" + rows.length + "条数据吗?", function() {
        			var url = table.options.removeUrl.replace("{ids}", rows.join());;
        			//alert(url);
